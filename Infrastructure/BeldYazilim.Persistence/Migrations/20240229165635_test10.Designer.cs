...
namespace BeldYazilim.Persistence.Migrations
{
    ...
    [Migration("20240229165635_test10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeldYazilim.Domain.Entities.UserInterest", b =>
                {
                    ...
                    b.Property<string>("UserInterestImageUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UserInterestName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BeldYazilim.Domain.Entities.UserInterest", b =>
                {
                    b.HasOne("BeldYazilim.Domain.Entities.AppUser", "AppUser")
                        .WithOne("UserInterest")
                        .HasForeignKey("BeldYazilim.Domain.Entities.UserInterest", "AppUserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
